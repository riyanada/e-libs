                ...
                <div class="form-validation">
                    <form class="form-valide" action="{{ route('users.update', $user->id) }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input id="name" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ $user->name }}" required autocomplete="name" autofocus placeholder="Username">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $profile->name }}" required autocomplete="name" autofocus placeholder="Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input id="name" type="text" class="form-control @error('no_telp') is-invalid @enderror" name="no_telp" value="{{ $profile->no_telp }}" required autocomplete="+62" autofocus placeholder="No Telp">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" value="{{ old('iname') }}" rows="5" placeholder="Alamat Rumah">{{$profile->alamat}}</textarea>
                                @error('idescription')
